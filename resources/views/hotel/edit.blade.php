		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<div class="form-group">
					...
					{{ Form::text('phone', null, array('class' => 'form-control', 'data-inputmask' => "'mask' : '(+99) 99 999 999'", 'required' => '','maxlength' => '20','type' => 'number')) }}
				</div>
				<div class="form-group">
			...
			<div class="col-md-4">
				<div class="well">
					<dl class="dl-horizontal">
						<dt>Ngày tạo:</dt>
						<dd>{{ date('l d/m/Y h:i a', strtotime($hotel->created_at)) }}</dd>
					</dl>

					<dl class="dl-horizontal">
						<dt>Ngày cập nhật:</dt>
						<dd>{{ date('l d/m/Y h:i a',strtotime($hotel->updated_at)) }}</dd>
					</dl>
					<hr>
					<div class="row">
						<div class="col-sm-6">
